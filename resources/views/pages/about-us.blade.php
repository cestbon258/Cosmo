            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="wow fadeInUp"  data-wow-delay="100ms" style="margin:-70px 20px; font-size: 16px !important;">
                        ...
                        <br>
                        The COSMO team has been extensively involved in the international real estatebusiness for over 10 years. Each of us feels much pride in being able to carry forth the USC Trojan quest for a better world for all. Responding to the increasing pressures of globalisation and the current economic environment, the three partners have taken this opportunity to create a distinctive real-estate service platform serving multifaceted vendor/landlord requirements and offering a unique channel for buyers to identify quality living spaces and good investment properties.
            ...
            <div class="row justify-content-center">
                ...
                <div class="modal" data-modal="trigger-1">
                    <article class="content-wrapper">
                        ...
                        <div class="content">
                            <span>
                                <p>Ms. Vivian Chan is the CEO and Co-Founder of COSMO Real Estate Limited. Prior to founding COSMO, Ms. Chan has been a serial entrepreneur, a seasoned investor, and a world traveller for over 15 years. Her professional expertise in global investments and real assets, coupled with her passion for technology, has led to the creation of COSMO – a technology-powered platform that provides property investment services and one-stop access to global properties.</p>
                                <p>Outside of COSMO, Vivian serves as the advisor of International Innovative Parks Alliance Association, and is also advisor to multiple local and regional start-ups.  Vivian holds a Master’s degree in Monash University and a Bachelor of Business Administration degree from the University of Southern California.</p>
                            </span>
                        </div>
                    </article>
                </div>
