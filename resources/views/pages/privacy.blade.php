...
@section('content')
  ...
  <strong>1. <div class="heading">PRIVACY</div></strong>
    ...
    <p class="terms subheading">1.1. Collecting Information about You</p>
    ...
    <p class="terms subheading">1.2. Cookies</p>
    ...
    <p class="terms subheading">1.3. Change to Privacy Policy</p>
    ...
    <p class="terms subheading">1.4. Use and Disclosure of Personal Information</p>
    ...
    <p class="terms subheading">1.5. Changing or Deleting Your Personal Information</p>
    ...
    <p class="terms subheading">1.6. Changes to the Privacy Policy</p>
    ...
    <strong>2. <div class="heading">SECURITY</div></strong>
