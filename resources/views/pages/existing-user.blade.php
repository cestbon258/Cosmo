    ...
    <div class="container-fluid">
        ...
        <div class="col">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="active-user-tab" data-toggle="tab" href="#" role="tab" aria-controls="active-user" aria-selected="false">Active Users</a>
                </li>
            </ul>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="active-user" role="tabpanel" aria-labelledby="active-user-tab">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <table id="active-user-table" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Email</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @csrf
                                                    ...
                                                    <input name="to" value="deactive" hidden>
                                                    <button type="submit" class="btn btn-outline-primary btn-sm">Deactive</button></td>
                                                </form>
                                            </td>
                                            <td>
