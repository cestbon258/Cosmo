    ...
    <div class="container-fluid">
        ...
        <div class="col">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" id="new-user-tab" data-toggle="tab" href="#" role="tab" aria-controls="new-user" aria-selected="true">New Users</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" id="inactive-user-tab" data-toggle="tab" href="#" role="tab" aria-controls="inactive-user" aria-selected="false">Inactive Users</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="inactive-user" role="tabpanel" aria-labelledby="inactive-user-tab">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <table id="inactive-user-table" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Email</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @csrf
                                                    ...
                                                    <input name="to" value="active" hidden>
                                                    <button type="submit" class="btn btn-outline-primary btn-sm">Active</button></td>
                                                </form>
                                            </td>
                                            <td>
